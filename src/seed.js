  ...
  try {
    ...
    if (productCount === 0) {
      await products.insertMany([
        ...
        {
          name: "Prego Aço Galvanizado 3/8\"",
          sku: "FER-001",
